...
* link:{fuse-url}[Red Hat Fuse Online, window="_blank"] console
* Example link:http://{node-js-url}[Node.js app, window="_blank"]
* Example link:http://{spring-boot-url}[Spring Boot app, window="_blank"]
