...
:fuse-flights-aggregator-app-name: fuse-flights-aggregator
...
. After the service is created, expand the new *{fuse-flights-aggregator-app-name}* API Service and select the *Configure APIcast* button.
...
. Select the *{fuse-flights-aggregator-app-name}* plan to return to the edit screen.
...
.. On the *{fuse-flights-aggregator-app-name}* application screen, scroll to the *API Credentials* section.
...
. Expand the *{fuse-flights-aggregator-app-name}* service.
...
. Select *{fuse-flights-aggregator-app-name}* from the *Monitoring* section.
