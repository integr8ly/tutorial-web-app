...
. Log into link:{enmasse-url}[EnMasse] by selecting the *OpenShift* button on the log in screen and accepting the permissions request.
...
* [ ] Check the *Addresses* screen of the link:{enmasse-url}[EnMasse] console to make sure the two addresses exist.
