...
IMPORTANT: The webapp will automatically open (http://localhost:3006) in your browser, however you must hard refresh the page before any content is rendered
